		...
		<div class="min-vh-100 p-3 mb-2 justify-content-around align-items-center">
			<div class="container d-flex justify-content-around align-items-center h-100">
				...
				<div class="d-flex justify-content-between align-items-center h-100">
					...
					<div class="border border-info text-black p-3 m-2 rounded d-flex justify-content-center align-items-center" style="height: 100px; width: 100px"><div>User</div></div>
				</div>
			</div>
		</div>
	</body>
